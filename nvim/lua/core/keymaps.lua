...
local function enter_resize_mode()
    vim.api.nvim_echo({ { "Resize mode: Press <Up>/<Down>/<Left>/<Right> to resize", "WarningMsg" } }, false, {})
    -- Temporarily remap arrow keys for resizing
    ...
    -- Exit resize mode with <Leader> or Esc
    vim.api.nvim_set_keymap('n', '<Leader>', ':lua exit_resize_mode()<CR>', opts)
    vim.api.nvim_set_keymap('n', '<Esc>', ':lua exit_resize_mode()<CR>', opts)
end

-- Function to exit resize mode
function exit_resize_mode()
    vim.api.nvim_echo({ { "Exited resize mode", "WarningMsg" } }, false, {})
...
-- Map <Leader><Leader> to enter resize mode
vim.keymap.set('n', '<Leader>r', function() enter_resize_mode() end, opts)
